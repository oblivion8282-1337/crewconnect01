...
const ResizableModal = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50">
      <div
        ref={modalRef}
        className="absolute bg-white rounded-xl shadow-2xl flex flex-col overflow-hidden"
        style={{
      ...
      >
        {/* Header - Draggable */}
        <div
          className={`flex justify-between items-center p-3 border-b bg-slate-50 select-none ${
