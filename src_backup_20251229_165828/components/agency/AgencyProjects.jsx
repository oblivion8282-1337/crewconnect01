...
const AgencyProjects = ({
  ...
  // Finde offene Optionen (bestätigte Optionen die noch nicht fix sind)
...
const OpenOptionsWarning = ({ options, onConvertToFix }) => (
  <div className="mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded-xl">
    ...
    {options.map(option => (
      <div
        key={option.id}
        className="flex justify-between items-center p-3 bg-white rounded-lg mb-2 last:mb-0"
      >
        <div>
        ...
        <div className="flex justify-between items-start">
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className={`px-2 py-0.5 rounded-full text-xs font-medium whitespace-nowrap ${PROJECT_STATUS_COLORS[project.status] || 'bg-gray-100 text-gray-700'}`}>
        ...
        <div>
          ...
          <button
            ...
            className={`w-full p-3 border rounded-lg text-left flex items-center justify-between transition-colors ${
              showDatePicker ? 'border-blue-500 ring-2 ring-blue-500' : 'hover:border-gray-400'
            }`}
          >
