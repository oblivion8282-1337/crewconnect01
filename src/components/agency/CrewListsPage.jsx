  ...
  const FreelancerCard = ({ freelancer, showRemoveFromList, listId }) => {
    ...
    return (
      <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
        ...
        >
          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-accent/20 to-accent/40 flex items-center justify-center text-sm font-medium text-gray-700 dark:text-gray-200 flex-shrink-0">
            {initials}
          </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              Freelancer hinzufügen
            </button>
            <button
              onClick={() => onOpenAddToListModal(null)}
              className="px-4 py-2 bg-accent text-gray-900 rounded-lg font-medium hover:bg-accent/90 transition-colors flex items-center gap-2"
            >
      ...
      <div className="space-y-4">
        ...
        {crewLists.length === 0 ? (
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-8 text-center">
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-4">Noch keine Crew-Listen erstellt</p>
            <button
              onClick={() => onOpenAddToListModal(null)}
              className="px-4 py-2 bg-accent text-gray-900 rounded-lg font-medium hover:bg-accent/90 transition-colors inline-flex items-center gap-2"
            >
              <Plus className="w-4 h-4" />
                  ...
                  <div className="p-4 flex items-center gap-3">
                    ...
                    {editingListId === list.id ? (
                      <input
                        ...
                        className="flex-1 px-2 py-1 rounded border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-accent focus:border-transparent"
                        autoFocus
                      />
                    ) : (
                      <div
