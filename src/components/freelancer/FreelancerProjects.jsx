      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-card shadow-sm p-6 mb-6 border border-gray-200 dark:border-gray-700">
          ...
          {myPhaseBookings.length === 0 ? (
            <p className="text-gray-400 dark:text-gray-500 text-center py-4">Keine Buchungen in dieser Phase</p>
          ) : (
                ...
                >
                  <div className="flex justify-between items-start mb-2">
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-medium text-gray-900 dark:text-white">{booking.agencyName}</span>
                      </div>
                    </div>
                  ...
                  <div className="flex flex-wrap gap-1 mb-3">
                    {booking.dates.map(date => (
                      <span key={date} className="px-2 py-1 text-xs rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300">
                        {formatDate(date)}
                      </span>
                    ))}
                  </div>
        ...
        {/* Team */}
        <div className="bg-white dark:bg-gray-800 rounded-card shadow-sm p-6 border border-gray-200 dark:border-gray-700">
          <h2 className="font-semibold mb-4 flex items-center gap-2 text-gray-900 dark:text-white">
          ...
          {phaseTeam.length === 0 ? (
            <p className="text-gray-400 dark:text-gray-500 text-center py-4">Keine weiteren Teammitglieder</p>
          ) : (
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-card shadow-sm p-6 mb-6 border border-gray-200 dark:border-gray-700">
          ...
          {selectedProject.project.description && (
            <p className="text-gray-600 dark:text-gray-400 mb-4">{selectedProject.project.description}</p>
          )}
        ...
        {/* Phasen */}
        <h2 className="font-semibold mb-4 text-gray-900 dark:text-white">Meine Phasen ({phases.length})</h2>
          ...
          {phases.map(phase => {
            ...
            return (
              <div
                ...
                className="bg-white dark:bg-gray-800 rounded-card shadow-sm p-5 cursor-pointer hover:shadow-md transition-all border border-gray-200 dark:border-gray-700"
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-6">
                    <div className="text-right">
                      <p className="font-bold text-gray-900 dark:text-white">{totalCost.toLocaleString('de-DE')}€</p>
                      <p className="text-sm text-gray-500 dark:text-gray-400">{totalDays} Tag{totalDays > 1 ? 'e' : ''}</p>
                    </div>
